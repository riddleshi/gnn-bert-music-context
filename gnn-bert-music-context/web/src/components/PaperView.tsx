const PAGES = Array.from({ length: 7 }, (_, i) => `/paper/page-${String(i + 1).padStart(2, "0")}.png`);
      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-mute">
            7-page NeurIPS-style report. Source is{" "}
            <code className="text-cream">report/final_report.md</code>; download the PDF if you want the
            typeset file.
          </p>
        </div>
        <a
          href="/paper/final_report.pdf"
