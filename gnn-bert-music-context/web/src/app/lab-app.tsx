    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-30 border-b border-line/80 bg-ink/85 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
          <a href="#lab" className="font-serif text-lg tracking-tight">
            Cadence Lab
          </a>
          <a
            href="/gnn-bert-music-context.zip"
            download
            className="shrink-0 rounded-full bg-copper px-3 py-1.5 text-xs font-medium text-ink hover:bg-copper/90 md:order-last"
          >
            Download zip
          </a>
          <nav className="flex max-w-[55%] gap-3 overflow-x-auto text-[11px] uppercase tracking-widest text-mute md:max-w-none md:flex-1 md:justify-end md:gap-4 md:text-xs">
            {NAV.map(([href, label]) => (
        ...
        <section id="lab" className="grid gap-10 py-14 lg:grid-cols-12 lg:py-20">
          <div className="lg:col-span-7">
            ...
            <p className="mt-5 max-w-xl text-lg text-mute">
              A hybrid GraphSAGE + TinyBERT system that reads a track as a structure graph and a caption,
              then predicts multi-label tags, valence/arousal, and retrieves matching clips.
            </p>
            ...
            <section id="metrics" className="mb-20">
              ...
              <Card className="mt-5">
                <CardHeader>
                  ...
                  <CardDescription>Replace these synthetic-corpus numbers with FMA / MTT / MusicCaps runs for the PDF report.</CardDescription>
                </CardHeader>
                <CardContent>
